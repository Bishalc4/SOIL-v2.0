function validate(values) {
    ...
    if (!values.username) {
        errors.username = 'Username is required'; }   // check if email field is empty
    if (values.username.length > 32) {   
        errors.username = 'Username length cannot be greater than 32'; }  // check if email is in incorrect format
